...
/**
 * 提前初始化EnumDictHandlerRegister
 *
 * @author Jia_RG
 * @see org.mybatis.spring.SqlSessionFactoryBean
 * @see EnumDictHandlerRegister#register
 * @see <a href="https://github.com/hs-web/hsweb-framework/issues/150">#150</a>
 */
public class SqlSessionFactoryBean
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
        ...
        EnumDictHandlerRegister.typeHandlerRegistry = targetConfiguration.getTypeHandlerRegistry();
        EnumDictHandlerRegister.register("org.hswebframework.web;" + this.typeHandlersPackage);
